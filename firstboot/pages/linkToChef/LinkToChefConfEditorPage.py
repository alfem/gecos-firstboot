...
#workstation is going to be unlinked from the Chef server.')))
    ...
    def translate(self):
        ...
        self.ui.lblUrlChefCertDesc.set_label(_('"Chef Certificate": Validation certificate URL in order to autoregister this workstation in the Chef server.'))
        self.ui.lblHostnameDesc.set_label(_('"Node Name": must be an unique name\n.'))
        self.ui.lblDefaultRoleDesc.set_label(_('"Default Group": a global group for all the workstations in your organization. If you are not an advanced Chef administrator, do not change this.'))
